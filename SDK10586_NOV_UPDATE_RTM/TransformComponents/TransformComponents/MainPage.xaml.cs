...
namespace TransformComponents
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        private void RotationToggle_Click(object sender, RoutedEventArgs e)
        {
            ...
            if(_mainVisual.RotationAngleInDegrees == 0)
            {
                _mainVisual.RotationAngleInDegrees = 45.0f;
            }
            else
            {
                _mainVisual.RotationAngleInDegrees = 0;
            }
        }
        ...
        private const float RectangleWidth = 300.0f;
        private const float RectangleHeight = 200.0f;

        private SpriteVisual _mainVisual;
