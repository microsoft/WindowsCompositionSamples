...
namespace CompositionSampleGallery.Samples.BrushInterop
{
    public sealed class ImageEffectBrush : XamlCompositionBrushBase
    {
        ...
        protected override void OnConnected()
        {
            ...
            // Use LoadedImageSurface API to get ICompositionSurface
            //LoadSurface();
            _surface = LoadedImageSurface.StartLoadFromUri(new Uri("msappx:///Assets/Background.png"), new Windows.Foundation.Size(300,300));
            ...
            // Fix for known lifetime issue for LoadedImageSurface in Creators Update (fixed for Insider builds)
        ...
        private void LoadSurface()
        {
            ...
            _surface = LoadedImageSurface.StartLoadFromUri(new Uri("msappx:///Assets/Background.png"));
        }
