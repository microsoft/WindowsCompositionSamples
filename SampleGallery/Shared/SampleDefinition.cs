...
namespace CompositionSampleGallery
{
    ...
    public class SampleDefinitions
    {
        ...
        static SampleDefinition[] _allDefinitions =
        {
                ...
                new SampleDefinition(SwipeScroller.StaticSampleName,                typeof(SwipeScroller),                SampleType.EndToEnd,  SampleCategory.DynamicHumanInteractions,   false, false, "ms-appx:///Assets/SampleThumbnails/SwipeScroller.PNG",                 sdkVersion: RuntimeSupportedSDKs.SDKVERSION._14393),
#endif

#if SDKVERSION_INSIDER
                new SampleDefinition(BorderPlayground.StaticSampleName,             typeof(BorderPlayground),             SampleType.Reference, SampleCategory.RealWorldUI,                false, true,   dateAdded: new DateTime(2017,08,02), imageUrl: "ms-appx:///Assets/SampleThumbnails/BorderEffects.PNG",           sdkVersion: RuntimeSupportedSDKs.SDKVERSION._INSIDER),
                new SampleDefinition(CompCapabilities.StaticSampleName,             typeof(CompCapabilities),             SampleType.Reference, SampleCategory.Conceptual,                 false, false,  dateAdded: new DateTime(2017,08,02), imageUrl: "ms-appx:///Assets/SampleThumbnails/CompositionCapabilities.PNG", sdkVersion: RuntimeSupportedSDKs.SDKVERSION._INSIDER),
