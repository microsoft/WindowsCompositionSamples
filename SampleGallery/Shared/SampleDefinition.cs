...
namespace CompositionSampleGallery
{
    ...
    public class SampleDefinitions
    {
        ...
        static SampleDefinition[] _allDefinitions =
        {
...
#if SDKVERSION_15063
                new SampleDefinition(BorderPlayground.StaticSampleName,             typeof(BorderPlayground),             SampleType.Reference, SampleCategory.RealWorldUI,                false, true,   dateAdded: new DateTime(2017,02,08), imageUrl: "ms-appx:///Assets/SampleThumbnails/BorderEffects.PNG",           sdkVersion: RuntimeSupportedSDKs.SDKVERSION._15063),
                new SampleDefinition(CompCapabilities.StaticSampleName,             typeof(CompCapabilities),             SampleType.Reference, SampleCategory.Conceptual,                 false, false,  dateAdded: new DateTime(2017,02,08), imageUrl: "ms-appx:///Assets/SampleThumbnails/CompositionCapabilities.PNG", sdkVersion: RuntimeSupportedSDKs.SDKVERSION._15063),
                new SampleDefinition(TransparentWindow.StaticSampleName,            typeof(TransparentWindow),            SampleType.EndToEnd,  SampleCategory.RealWorldUI,                true,  true,   dateAdded: new DateTime(2017,02,08), imageUrl: "ms-appx:///Assets/SampleThumbnails/TransparentWindow.PNG",       sdkVersion: RuntimeSupportedSDKs.SDKVERSION._15063),
                new SampleDefinition(NavigationFlow.StaticSampleName,               typeof(NavigationFlow),               SampleType.EndToEnd,  SampleCategory.SeamlessTransitions,        false, false,  dateAdded: new DateTime(2017,02,08), imageUrl: "ms-appx:///Assets/SampleThumbnails/NavigationFlow.PNG",          sdkVersion: RuntimeSupportedSDKs.SDKVERSION._15063),
                new SampleDefinition(ShowHideImplicitWebview.StaticSampleName,      typeof(ShowHideImplicitWebview),      SampleType.EndToEnd,  SampleCategory.SeamlessTransitions,        false, false,  dateAdded: new DateTime(2017,02,28), imageUrl: "ms-appx:///Assets/SampleThumbnails/ShowHideImplicitWebview.PNG", sdkVersion: RuntimeSupportedSDKs.SDKVERSION._15063),
                ...
                new SampleDefinition(BrushInterop.StaticSampleName,                 typeof(BrushInterop),                 SampleType.Reference, SampleCategory.Conceptual,                 true,  true,   dateAdded: new DateTime(2017,06,21), imageUrl: "ms-appx:///Assets/SampleThumbnails/BrushInterop.PNG",            sdkVersion: RuntimeSupportedSDKs.SDKVERSION._15063),
                new SampleDefinition(LightInterop.StaticSampleName,                 typeof(LightInterop),                 SampleType.Reference, SampleCategory.RealWorldUI,                true,  true,   dateAdded: new DateTime(2017,06,21), imageUrl: "ms-appx:///Assets/SampleThumbnails/LightInterop.PNG",            sdkVersion: RuntimeSupportedSDKs.SDKVERSION._15063),
                new SampleDefinition(Interactions3D.StaticSampleName,               typeof(Interactions3D),               SampleType.EndToEnd,  SampleCategory.DynamicHumanInteractions,   false, false,                                       imageUrl: "ms-appx:///Assets/SampleThumbnails/Interaction3D.PNG",           sdkVersion: RuntimeSupportedSDKs.SDKVERSION._15063),
#endif
