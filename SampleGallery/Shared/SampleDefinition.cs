...
namespace CompositionSampleGallery
{
    ...
    public class SampleDefinitions
    {
        ...
        static SampleDefinition[] _allDefinitions =
        {
                ...
                new SampleDefinition(OffsetStompingFix.StaticSampleName,            typeof(OffsetStompingFix),            SampleType.Reference, SampleCategory.Conceptual,                 false, false,  dateAdded: new DateTime(2017,04,18), imageUrl: "ms-appx:///Assets/SampleThumbnails/Offset_Stomping.gif",         sdkVersion: RuntimeSupportedSDKs.SDKVERSION._INSIDER),
#endif
