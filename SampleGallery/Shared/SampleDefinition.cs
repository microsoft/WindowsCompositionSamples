...
namespace CompositionSampleGallery
{
    ...
    public class SampleDefinitions
    {
        ...
        static SampleDefinition[] _allDefinitions =
        {
                ...
                new SampleDefinition(BlurPlayground.StaticSampleName,               typeof(BlurPlayground),               SampleType.Reference, SampleCategory.Conceptual,                 true,  true,  "ms-appx:///Assets/SampleThumbnails/BlurPlayground.PNG",                                                          sdkVersion: RuntimeSupportedSDKs.SDKVERSION._15063),
