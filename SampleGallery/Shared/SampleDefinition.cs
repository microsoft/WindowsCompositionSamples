...
namespace CompositionSampleGallery
{
    ...
    public class SampleDefinitions
    {
        ...
        static SampleDefinition[] _allDefinitions =
        {
                ...
                new SampleDefinition(Win2DInterop.StaticSampleName,                 typeof(Win2DInterop),                 SampleType.Reference, SampleCategory.Conceptual,                 true,  true,  "ms-appx:///Assets/SampleThumbnails/Win2DInterop.PNG",                  sdkVersion: RuntimeSupportedSDKs.SDKVERSION._14393 ),
#endif
